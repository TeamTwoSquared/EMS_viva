...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 09, 2019 at 01:27 PM
...
INSERT INTO `bookings` (`booking_id`, `date`, `stime`, `etime`, `status`, `service_provider_id`, `service_id`) VALUES
(4, '2019-03-06', '14:00:00', '19:00:00', 1, 12, NULL),
(5, '2019-03-06', '14:00:00', '19:00:00', 1, 12, NULL),
(7, '2019-01-01', '01:00:00', '01:00:00', 1, 12, NULL),
(8, '2019-01-08', '14:00:00', '19:00:00', 1, 12, NULL);
...
INSERT INTO `contact_us` (`feedback_no`, `name`, `email`, `tel`, `messege`) VALUES
(1, 'gayan sampath', 'gayansampathmanamendra@gmail.com', 763661600, 'sdaf'),
(2, 'service 1', 'sajunsandaruwan@gmail.com', 763661600, 'sdfghm');
...
--
-- Dumping data for table `help_and_comment`
--

INSERT INTO `help_and_comment` (`comment_id`, `support_request_id`, `comment`, `customer_id`, `service_provider_id`, `from_whome`) VALUES
(1, 1, 'hhiiiiii', NULL, NULL, 1),
(2, 1, 'byee', 1, NULL, 2),
(3, 1, '444', NULL, NULL, 1),
(4, 1, '888', NULL, NULL, 1),
(5, 1, '88', NULL, NULL, 1),
...
INSERT INTO `notifications` (`notification_id`, `notification`, `support_request_id`, `type`, `to_whome`, `from_whome`, `is_read`, `customer_id`, `service_provider_id`) VALUES
(1, 'You Have A Support Request From Your Client sajun', 1, 1, 1, 2, 1, 1, NULL),
(2, 'EMS Support Center', 1, 2, 2, 1, 1, 1, NULL),
(3, 'You Have A Comment Of Support Request From Your Client sajun', 1, 2, 1, 2, 1, 1, NULL),
(4, 'EMS Support Center', 1, 2, 2, 1, 0, 1, NULL),
(5, 'EMS Support Center', 1, 2, 2, 1, 0, 1, NULL),
(6, 'EMS Support Center', 1, 2, 2, 1, 0, 1, NULL),
(7, 'You Have A Support Request From Your Service Provider 1234', 2, 1, 1, 3, 1, NULL, 12),
(8, 'You Have A Support Request From Your Client sajun', 3, 1, 1, 2, 1, 1, NULL),
(9, 'You Have A Support Request From Your Service Provider 1234', 4, 1, 1, 3, 1, NULL, 12),
(10, 'EMS Support Center', 1, 2, 2, 1, 0, 1, NULL),
(11, 'You Have A Support Request From Your Service Provider 1234', 5, 1, 1, 3, 0, NULL, 12),
(12, 'EMS Support Center', 4, 2, 3, 1, 1, NULL, 12),
(13, 'You have a comment of support request from your service provider 1234', 4, 2, 1, 3, 0, NULL, 12);
...
INSERT INTO `support_requests` (`support_request_id`, `request`, `customer_id`, `service_provider_id`, `type_id`, `from_whome`) VALUES
(1, 'problem 1', 1, NULL, 7, 2),
(2, 'klj', NULL, 12, 7, 3),
(3, 'vdc', 1, NULL, 7, 2),
(4, 'vvbvf', NULL, 12, 7, 3),
(5, 'vfdbvf', NULL, 12, 7, 3);
...
--
-- Dumping data for table `support_request_attachements`
--

INSERT INTO `support_request_attachements` (`support_request_id`, `attachement_url`, `type_id`) VALUES
(2, 'Chrysanthemum_1546923806.jpg', 7);
