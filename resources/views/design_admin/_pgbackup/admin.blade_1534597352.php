                ...
                <div class="menu-sidebar__content js-scrollbar1"> 
                    <nav class="navbar-sidebar"> 
                        <ul class="list-unstyled navbar__list"> 
                            ...
                            <li> 
                                <a href="chart.html"><i class="fas fa-chart-bar"></i>Manage Events</a> 
                            </li>                             
                            <li> 
                                <a href="table.html"> <i class="fas fa-table"></i>Manage Service Providers</a> 
                            </li>                             
                            <li> 
                                <a href="form.html"> <i class="far fa-check-square"></i>Manage Clients</a> 
                            </li>                             
                            <li> 
                                <a href="#"> <i class="fas fa-calendar-alt"></i>Manage Payments</a> 
                            </li>                             
                            <li> 
                                <a href="map.html"> <i class="fas fa-map-marker-alt"></i>Manage Ads</a> 
                            </li>                             
                            <li> 
                                <a href="#"> <i class="fas fa-copy"></i>Support Requests</a> 
                            </li>                             
                            <li> 
                                <a href="#"> <i class="fas fa-desktop"></i>Manage Security</a> 
                            </li>                             
                        </ul>                         
                    </nav>                     
                </div>                 
