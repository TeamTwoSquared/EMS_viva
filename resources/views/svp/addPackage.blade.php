    ...
    <div class="section__content section__content--p30"> 
        <div class="container-fluid">
            ...
            <div class="row" data-pg-collapsed> 
                <div class="col-lg-9"> 
                    <div class="card"> 
                        <div class="card-header"><center><h2><i>Add new service package</i></h2></center></div>             
                        <div class="card-body card-block"> 
                            ...
                            {{ csrf_field() }}
                                ...
                                <div class="form-group"> 
                                    <label for="inputAddress">Package prices (Rs.)-Optional</label>                         
                                    <input type="number" class="form-control"  name="price" min=0 placeholder="Price Your Service ">
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail4">Package description</label>
