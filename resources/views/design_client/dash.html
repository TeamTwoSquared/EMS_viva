                    ...
                    <div class="header3-wrap"> 
                        ...
                        <div class="header__navbar"> 
                            <ul class="list-unstyled"> 
                                ...
                                <li> 
                                    <a href="/client/event"> <i class="fas fa-shopping-basket"></i> <span class="bot-line"></span>My Events</a>
                                </li>
                                <li> 
                                    <a href="/client/inbox"> <i class="fas fa-shopping-basket"></i> <span class="bot-line"></span>Messeges</a> 
                                </li>
                                <li> 
                                    <a href="/client/help"> <i class="fas fa-trophy"></i> <span class="bot-line"></span>Support Center</a> 
                                </li>                                 
                            </ul>                             
                        </div>                         
